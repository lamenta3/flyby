...
namespace FlyBy
{
    ...
    public partial class Popup : Window
    {
        ...
        public Popup(String heading, String body, String imageSource, Int32 numPopups)
        {
            ...
            animation.KeyFrames.Add(new SplineDoubleKeyFrame(1, KeyTime.FromTimeSpan(TimeSpan.FromSeconds(App.Instance().Options.NotificationDisplayTime))));
            animation.KeyFrames.Add(new SplineDoubleKeyFrame(0, KeyTime.FromTimeSpan(TimeSpan.FromSeconds(App.Instance().Options.NotificationDisplayTime + 1))));
